  ...
  <div class="container">
    <div class="show-galleries" v-if="gallery">
      ...
      <hooper :itemsToShow="4" pagination="fraction">
        ...
        <slide v-for="(gallery, index) in productDetail.galleries" :key="index">
          <div class="item">
      ...
      <div class="content-text col-7">
        <div class="content-text-detail">
          ...
          <div class="count-buy d-flex">
            ...
            <div class="buy">(đã bán : {{ productDetail.id }})</div>
          </div>
          <div class="price">
          ...
          <div class="add-cart">
            <button class="btn btn-primary" @click="addCart(productDetail.id)">
              ADD TO CART
            </button>
          </div>
        </div>
