    ...
    <div class="container-book">
      ...
      <div class="book-product">
        ...
        <div class="book-view">
          ...
          <div class="list-book">
            <div class="product-exist" v-if="listPro.length == 0">
              <img
                src="/storage/image/a60759ad1dabe909c46a817ecbf71878.png"
                alt=""
              />
              <p>Oops , Không tìm thấy sản phẩm thoả mãn !</p>
            </div>
            <div
              class="item"
              :if="listPro.length > 0"
              v-for="(products, index) in listPro"
              :key="index"
            >
    ...
    priceRange(e, id) {
      if (typeof e === "undefined" && typeof id === "undefined") {
        ...
        if (
          this.price.min == 0 &&
          this.price.max == 0 &&
          this.selected.price.length == 0
        ) {
          this.$router.replace({
            query: _.omit(this.$route.query, "priceMin"),
          });
          this.$router.replace({
            query: _.omit(this.$route.query, "priceMax"),
          });
        }
      }
    },
